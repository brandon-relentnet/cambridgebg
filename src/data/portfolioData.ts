...
export const projectDetails: Record<number, ProjectDetail> = {
  1: {
    ...
    featured: true,
    fullDescription:
      '<p>The Riverfront Commercial Plaza represents the pinnacle of modern sustainable commercial development. This ambitious project transformed a formerly underutilized waterfront area into a vibrant mixed-use destination that serves as both an economic catalyst and community gathering space.</p><p>Spanning 250,000 square feet, the development includes Class A office space, upscale retail outlets, dining establishments, and public plazas with direct river access. The design seamlessly integrates indoor and outdoor environments, creating a harmonious relationship between the built environment and the natural waterfront setting.</p><p>Cambridge Building Group implemented numerous sustainable features that earned the project LEED Platinum certification, including:</p>',
    sustainableFeatures: [
  ...
  2: {
    ...
    featured: true,
    fullDescription:
      "<p>The Madison Opera House restoration project represented a perfect balance between honoring architectural history and incorporating modern functionality. This cherished local landmark, originally built in 1924, had fallen into disrepair over decades of neglect before Cambridge Building Group undertook its comprehensive restoration.</p><p>Our team of preservation specialists worked closely with historians, acoustical engineers, and theatrical consultants to revive the venue's grandeur while ensuring it could meet the demands of contemporary performances and audiences.</p><p>The project's success has not only returned a historic gem to the community but has also sparked broader revitalization efforts in the surrounding downtown district.</p>",
    sustainableFeatures: [
    ...
    galleryImages: [
      ...
      {
        id: 6,
        title: 'Modern Stage Technology',
        image: '/opera-house-6.jpg',
      },
    ],
