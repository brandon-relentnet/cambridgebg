        ...
        <div className="w-full lg:w-1/2">
          ...
          <div className="border-l-2 border-slate-700 pl-4">
            <p className="text-lg text-slate-700 mb-4">
              ...
              designs and unwavering commitment to quality. With decades of combined experience, our
              team of experts transforms visions into structures that inspire and endure.
            </p>
            <p className="text-lg text-slate-700 mb-4">
              ...
              cutting&#8209;edge technology with traditional craftsmanship to deliver projects that
