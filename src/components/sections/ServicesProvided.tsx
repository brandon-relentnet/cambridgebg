...
export function ServicesProvided({ showButton = false }: ServicesProvidedProps) {
  ...
  return (
    <section id="services-provided" className="relative px-8 2xl:px-60 py-section bg-slate-100">
      <div className="container mx-auto py-block">
        <div className="w-full md:w-1/2 mb-12">
          <h2 className="text-5xl font-bold text-navy mb-4">Services Provided</h2>
          <p className="text-lg text-slate-700 mb-6">
            Cambridge Building Group offers a comprehensive suite of construction services tailored
            to meet the diverse needs of our clients. From concept to completion, we apply our
            expertise at every stage of the building process.
          </p>
          <div className="flex">
            {showButton && (
              <button
