          ...
          <ScrollReveal direction="left">
            <div>
              <div className="flex items-center mb-4">
                ...
                <h2 className="font-display mb-4 font-bold text-5xl">Trade Partners</h2>
              </div>
              ...
              <div className="my-8 pl-4 border-slate-400 border-l-2">
                <p className="text-lg italic">
                  ...
                  team for each project, ensuring specialized expertise and consistent quality
                  across all aspects of construction.&rdquo;
                </p>
              </div>
            </div>
          </ScrollReveal>
