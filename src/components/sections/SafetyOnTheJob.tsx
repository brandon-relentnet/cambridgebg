          ...
          <div className="flex flex-col md:flex-row justify-between items-start mb-16">
            <div className="w-full md:w-2/3 mb-6 md:mb-0">
              <div className="flex items-center mb-4">
                ...
                <h2 className="font-display text-5xl font-bold">Safety on the Job Site</h2>
              </div>
              <p className="text-xl">
                At Cambridge Building Group, safety isn&apos;t just a priority&mdash;it&apos;s a
                core value ingrained in every aspect of our operations. We maintain an unwavering
